...
#define BG_32x32    (0 << 14)		@ 32 x 32 tile text background 
#define BG_64x32    (1 << 14)		@ 64 x 32 tile text background 
#define BG_32x64    (2 << 14)		@ 32 x 64 tile text background 
#define BG_64x64    (3 << 14)		@ 64 x 64 tile text background 

#define BG_RS_16x16   (0 << 14)		@ 16 x 16 tile affine (rotation & scale) background 
#define BG_RS_32x32   (1 << 14)		@ 32 x 32 tile affine (rotation & scale) background 
#define BG_RS_64x64   (2 << 14)		@ 64 x 64 tile affine (rotation & scale) background 
#define BG_RS_128x128 (3 << 14)		@ 128 x 128 tile affine (rotation & scale) background 
...
#define BG_MOSAIC_ON   (BIT(6))		@ mosaic enable 
#define BG_MOSAIC_OFF  (0)			@ mosaic disable

#define BG_PRIORITY_0  (0)			@ Lower priority will be rendered on top 
#define BG_PRIORITY_1  (1)			@ Lower priority will be rendered on top 
#define BG_PRIORITY_2  (2)			@ Lower priority will be rendered on top 
#define BG_PRIORITY_3  (3)			@ Lower priority will be rendered on top 

#define BG_WRAP_OFF    (0)			@ Disable wrapping (no effect on text backgrounds...always wrapped) 
#define BG_WRAP_ON     (1 << 13)	@ Enable wrapping (no effect on text backgrounds...always wrapped) 

#define BG_PALETTE_SLOT0 0			@ Use slot 0 of extended palettes 
#define BG_PALETTE_SLOT1 0			@ Use slot 1 of extended palettes 
#define BG_PALETTE_SLOT2 BIT(13)	@ Use slot 2 of extended palettes 
#define BG_PALETTE_SLOT3 BIT(13)	@ Use slot 3 of extended palettes 

#define BG_COLOR_256	0x80		@ 256 color text background 
#define BG_COLOR_16		0x00		@ 16x16 color text background 
